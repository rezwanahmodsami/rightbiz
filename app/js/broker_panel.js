...
$('.navbar-toggle').click(function () {
	var ths = $(this);
	var target = $(this).data('target');console.log(target);
	$('.navbar-toggle').not(this).addClass('collapsed');
	$(this).toggleClass('collapsed');
	$('.collapse-cn').not(target).removeClass('in').slideUp(200);
...
/* ####--- tab module ---#### */
/* ///////////////////////////////////// */
$(document).on('click', '.tab_cn .tab', function(){
	tab_cn = $(this).closest('.tab_cn');console.log(tab_cn);
	if(tab_cn.find('.tab_group.selected').length){
		tab_cn.find('.tab_group.selected').removeClass('selected');
		tab_cn.find('.tab.selected').removeClass('selected');
	}
	$(this).addClass('selected');
	tab_cn.find('.tab_group.'+($(this).attr('for'))).addClass('selected');
});
